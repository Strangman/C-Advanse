        ...
        public static void Initialize(ProjectContext context)
        {
            if (!context.Games.Any())
            {
                Store store1 = new Store()
                {
                    ...
                    "многопользовательских игр и потокового вещания, а также социальной сети для игроков.", StoreLink = "https://store.steampowered.com/",
                    ImgLink = "Steam.png"
                };
                Store store2 = new Store()
                {
                    ...
                    StoreLink = "https://www.epicgames.com/store/ru", ImgLink = "Epic.png"
                };
                ...
                Studio studio1 = new Studio() { Name = "Capcom", ImgLink = "Capcom.png", Foundation = 1979, 
                ...
                Studio studio2 = new Studio() { Name = "EA DICE", ImgLink = "DICE.png", Foundation = 1992, 
                ...
                News_single news1 = new News_single() { Title = "Онлайн The Witcher 3: Wild Hunt побил рекорд дополнения Blood and Wine", 
                ...
                News_single news2 = new News_single() { Title = "Capcom Details ‘Monster Hunter World: Iceborne’ 12.01 Update in Latest Dev Diary", 
                ...
                DLC dlc1 = new DLC() { Name = "Battlefield 1 «Во имя Царя»", Discription = "Очутитесь на крупнейшем фронте Первой мировой в самом масштабном на " +
                    ...
                    Price = 100, Game = game2, Studio = studio2, ImgLink = "BF1DLC.jpg"
                };
                DLC dlc2 = new DLC()
                {
